      ...
      <section className="rounded-2xl border border-slate-200 bg-gradient-to-br from-white to-slate-50/50 p-6 shadow-lg">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          >
            ...
            <div>
              <p className="font-semibold text-slate-900">Download Statement</p>
              <p className="text-xs text-slate-500">Monthly reports</p>
            </div>
          </Link>
          ...
          <div className="rounded-xl border border-cyan-200 bg-white p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">PQ + RSA hybrid</p>
              </div>
            </div>
            <div className="mt-3 rounded-lg bg-cyan-50 px-3 py-1.5">
              <div className="flex items-center justify-between text-xs">
                <span className="text-slate-600">Algorithm:</span>
                <span className="font-mono font-semibold text-cyan-700">ML-KEM + RSA</span>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-indigo-200 bg-white p-4">
            ...
            <div className="mt-3 space-y-1">
              <div className="flex items-center justify-between text-xs">
                ...
                <span className="font-medium text-slate-900">{new Date().toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit' })}</span>
              </div>
              <div className="flex items-center justify-between text-xs">
                <span className="text-slate-600">Location:</span>
                <span className="font-medium text-slate-900">Secure Portal</span>
              </div>
            </div>
          </div>
        </div>
